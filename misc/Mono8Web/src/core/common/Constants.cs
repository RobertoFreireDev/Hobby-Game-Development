...
public static class Constants
{
    ...
    public static class GameDataSizes
    {
        ...
        // Cap on the cartridge's Lua source (the __lua__ section), in characters.
        public const int LuaMaxLength = 524288;
    }
    ...
    public static class File
    {
        ...
        {
            // The whole cartridge (gfx, gff, atl, map, sfx, music) in one sectioned file. data.icons
            // (built-in, read-only) and data.save (runtime dget/dset store) stay separate files.
            public const string Cart = "mono8";

            // The cartridge's Lua game source, stored as the first __lua__ section of data.mono8.
