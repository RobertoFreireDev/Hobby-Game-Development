...
{
    /// <summary>Save the whole cartridge to a host-chosen file (browser "save as" dialog on the web head).</summary>
    void ExportCart();

    /// <summary>Load a whole cartridge from a host-chosen file (browser file picker on the web head).</summary>
    void ImportCart();
