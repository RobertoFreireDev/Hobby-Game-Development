...
function dwdlg()
 ...
 -- 4px clear of the portrait box, which ends at y=49
 panel(4,50,124,102)
 local n=dtick\2
 for i=1,#dlines do
  local l=dlines[i]
  if n<=0 then break end
  print(sub(l,1,min(n,#l)),9,56+(i-1)*8,7)
  n-=#l
 end
 print(dpage.."/"..#stm[dv],108,94,5)
 if dtick\2>=dtotal then print("🅾️",96,94,6) end
end
...
rmpd="0123456789abcdef|0123455684a3cde4|0121255d82a11de2|0101011180911e0|0111112782211122"
