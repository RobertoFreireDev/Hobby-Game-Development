...
public class PixelledSpriteBatch
{
    ...
    public void DrawPixel(int x, int y, int colorIndex = 1)
    {
        _spriteBatch.Draw(PixelTexture, new Rectangle(x, y, 1, 1), ColorPalette.GetColor(colorIndex));
    }

    public void DrawRect(int x, int y, int width, int height, int colorIndex = 1)
    {
    ...
    public void DrawRectFill(int x, int y, int width, int height, int colorIndex = 1)
    {
    ...
    public void Draw(RenderTarget2D sceneTarget, Rectangle boxToDraw, Color color)
    {
        _spriteBatch.Draw(sceneTarget, boxToDraw, color);
    }
